...
class AndroidTools {
	...
	// public static function installapk(path:String) {
	// 	#if android
	// 	return installapk_jni(path);
	// 	#end
	// 	return null;
	// }
	...
	private static var installapk_jni = JNI.createStaticMethod("org.haxe.extension.AndroidTools", "installapk", "(Ljava/lang/String;)V");
